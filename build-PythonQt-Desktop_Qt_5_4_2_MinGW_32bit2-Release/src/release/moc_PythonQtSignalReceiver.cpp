...
#include "../../../PythonQt3.0/src/PythonQtSignalReceiver.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_PythonQtSignalReceiverBase_t, stringdata) + ofs \
...
void *PythonQtSignalReceiverBase::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_PythonQtSignalReceiverBase.stringdata))
