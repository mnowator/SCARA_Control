...
#include "../../../PythonQt3.0/generator/shellimplgenerator.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ShellImplGenerator_t, stringdata) + ofs \
...
void *ShellImplGenerator::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ShellImplGenerator.stringdata))
