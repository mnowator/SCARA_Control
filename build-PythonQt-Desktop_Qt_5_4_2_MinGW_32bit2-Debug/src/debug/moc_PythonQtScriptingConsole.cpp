...
#include "../../../PythonQt3.0/src/gui/PythonQtScriptingConsole.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_PythonQtScriptingConsole_t, stringdata) + ofs \
...
void *PythonQtScriptingConsole::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_PythonQtScriptingConsole.stringdata))
